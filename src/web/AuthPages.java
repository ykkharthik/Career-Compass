...
public final class AuthPages {
    ...
    public void landingPage(HttpExchange ex) throws IOException {
        ...
        String body = "<div class=\"hero\">"
                ...
                + "<p class=\"lede\"><b>For&nbsp;students:</b> a clear, explainable career direction, "
                + "not generic advice. <b>For&nbsp;mentors:</b> a direct way to guide people who are "
                + "ready to listen. <b>For&nbsp;industry&nbsp;specialists:</b> verified skills you can "
                + "trust, not just a r&eacute;sum&eacute;. One platform, five connected roles, all "
                + "pulling in the same direction.</p>"
                + "<div class=\"cta-row\">"
